...
const updateClassQuery =
  'UPDATE classes SET class_code = $1, course_id = $2, date_start = $3, date_finish = $4, day_of_week = $5, time_start = $6, time_finish = $7, teacher_id = $8 WHERE class_id = $9 RETURNING *';
