...
const TeacherAttendanceClass = () => {
  ...
  const getTitle = (type) => {
    switch (type) {
      case 1:
        return "Traditional Attendance";
      case 2:
        return "QR Code Attendance";
      case 3:
  ...
  const title = getTitle(attendanceType);
  ...
  const handleDatePress = (classId, date) => {
    ...
    switch (attendanceType) {
      case 1:
        targetScreen = 'TraditionalAttendance';
        break;
      case 2:
        targetScreen = 'QrCodeAttendance';
        break;
      case 3:
        targetScreen = 'FaceRecognitionAttendance';
        break;
    }
