            ...
            <div className="profile-container">
              ...
              <div className="info-section">
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8">{userData.student_code} </div>
                </div>
                <div className="row mb-3">
                  <div className="col-2"></div>
                  <div className="col-2 fw-bold">Class: </div>
                  <div className="col-8">{userData.student_class} </div>
                </div>
                <div className="row mb-3">
                  <div className="col-2"></div>
                  <div className="col-2 fw-bold">Gender: </div>
                  <div className="col-8">{userData.gender} </div>
                </div>
                <div className="row mb-3">
                  <div className="col-2"></div>
                ...
                <div className="row">
                  <div className="col-2"></div>
                  <div className="col-2 fw-bold">Classes Attended:</div>
                  <div className="col-8">
                    <List
